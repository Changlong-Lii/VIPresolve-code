...
struct HighsOptionsStruct {
  ...
  bool use_aggregation_VI;
  bool use_variable_bound_tightening;
  bool use_variable_bound_tightening_knap2013;
  bool use_variable_bound_tightening_obj;
  bool use_variable_bound_tightening_two;
  ...
  HighsOptionsStruct()
      : presolve(""),
        ...
        use_aggregation_VI(false),
        use_variable_bound_tightening(false),
        use_variable_bound_tightening_knap2013(false),
        use_variable_bound_tightening_obj(false),
        use_variable_bound_tightening_two(false),
#ifdef HIGHS_DEBUGSOL
 ...
 private:
  void initRecords() {
    ...
    */
    ...
    record_bool = new OptionRecordBool("aggregation_VI",
                                       "Enables or disables aggregation of VI",
                                       advanced, &use_aggregation_VI, false);
    records.push_back(record_bool);

    record_bool = new OptionRecordBool("variable_bound_tightening",
                                       "Enables or disables variable bound tightening",
                                       advanced, &use_variable_bound_tightening, false);
    records.push_back(record_bool);

    record_bool = new OptionRecordBool("variable_bound_tightening_knap2013",
                                       "Enables or disables variable bound tightening of knapsack in 2013",
                                       advanced, &use_variable_bound_tightening_knap2013, false);
    records.push_back(record_bool);

    record_bool = new OptionRecordBool("variable_bound_tightening_obj",
                                       "Enables or disables objectiver variable bound tightening",
                                       advanced, &use_variable_bound_tightening_obj, false);
    records.push_back(record_bool);

    record_bool = new OptionRecordBool("variable_bound_tightening_two",
                                       "Enables or disables two column variable bound tightening",
                                       advanced, &use_variable_bound_tightening_two, false);
    records.push_back(record_bool);
